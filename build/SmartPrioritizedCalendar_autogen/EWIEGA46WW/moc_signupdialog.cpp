/****************************************************************************
** Meta object code from reading C++ file 'signupdialog.hpp'
**
...
#error "The header file 'signupdialog.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SignUpDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SignUpDialog_t qt_meta_stringdata_SignUpDialog = {
    {
        QT_MOC_LITERAL(0, 12),  // "SignUpDialog"
        QT_MOC_LITERAL(13, 15),  // "onCreateAccount"
        QT_MOC_LITERAL(29, 0)   // ""
    },
    "SignUpDialog",
    "onCreateAccount",
...
Q_CONSTINIT static const uint qt_meta_data_SignUpDialog[] = {
...
Q_CONSTINIT const QMetaObject SignUpDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_SignUpDialog.offsetsAndSizes,
    qt_meta_data_SignUpDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SignUpDialog_t,
        // Q_OBJECT / Q_GADGET
